...
public class SettingsHomescreen extends CollapsingToolbarBaseActivity
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (LauncherPrefs.SHOW_HOTSEAT_BG.getSharedPrefKey().equals(key) ||
                ...
                LauncherPrefs.ALLOW_WALLPAPER_ZOOMING.getSharedPrefKey().equals(key) ||
                LauncherPrefs.SLEEP_GESTURE.getSharedPrefKey().equals(key) ||
                LauncherPrefs.ENABLE_MINUS_ONE.getSharedPrefKey().equals(key)) {
