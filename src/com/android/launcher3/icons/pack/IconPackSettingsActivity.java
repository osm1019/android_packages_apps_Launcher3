...
public final class IconPackSettingsActivity extends CollapsingToolbarBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            final Fragment f = getSupportFragmentManager().getFragmentFactory().instantiate(
                    getClassLoader(), getString(R.string.icon_pack_settings_class));
    ...
    private boolean startFragment(String fragment, Bundle args, String key) {
        ...
        final Fragment f = getSupportFragmentManager().getFragmentFactory()
                .instantiate(getClassLoader(), fragment);
        f.setArguments(args);
